                ...
                <form class="wpie_import_frm" method="post" action="#">
                        ...
                        <div class="wpie_content_data">
                                                                        ...
                                                                        <div class="wpie_content_data_wrapper">
                                                                                <select class="wpie_content_data_select wpie_import_type_select" name="wpie_import_type">
                                                                                        <?php if ( ! empty( $wpie_import_type ) ) { ?>
                                                                                                <?php foreach ( $wpie_import_type as $key => $val ) { ?>
                                ...
                                <div class="wpie_section_container wpie_import_step3 wpie_import_step">
                                        ...
                                        <div class="wpie_section_wrapper">
                                                <div class="wpie_content_data_header wpie_section_wrapper_selected">
                                                        <div class="wpie_content_title"><?php esc_html_e( 'Data Filter', 'woo-import-export' ); ?></div>
                                                </div>
                                                <div class="wpie_section_content wpie_show">
                                                                        ...
                                                                        <td class="wpie_element_data_wrapper">
                                                                                ...
                                                                                <div class="wpie_csv_delimiter_wrapper">
                                                                                        <table class="wpie_csv_delimiter_outer_wrapper">
                                                                                                <tr>
                                                                                                        <td class="wpie_csv_delimiter_container"><?php esc_html_e( 'Set delimiter for CSV fields', 'woo-import-export' ); ?></td>
                                                ...
                                                <div class="wpie_section_content wpie_show">
                                                        ...
                                                        <div class="wpie_import_existing_item_section">
                                                                <div class="wpie_field_mapping_container_wrapper">
                                                                        <div class="wpie_field_mapping_container_title"><?php esc_html_e( 'Handle Existing Items', 'woo-import-export' ); ?><div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                                                        ...
                                                        <div class="wpie_import_manage_template_section">
                                                                <div class="wpie_field_mapping_container_wrapper">
                                                                        <div class="wpie_field_mapping_container_title"><?php esc_html_e( 'Load & Save Template', 'woo-import-export' ); ?><div class="wpie_layout_header_icon_wrapper"><i class="fas fa-chevron-up wpie_layout_header_icon wpie_layout_header_icon_collapsed" aria-hidden="true"></i><i class="fas fa-chevron-down wpie_layout_header_icon wpie_layout_header_icon_expand" aria-hidden="true"></i></div></div>
                                                                        <div class="wpie_field_mapping_container_data">
                                                                                <div class="wpie_field_mapping_container_outer">
                                                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Load Template', 'woo-import-export' ); ?></div>
                                                                                        <div class="wpie_image_option_wrapper">
                                                                                                <select class="wpie_content_data_select wpie_template_list" name="">
                                                                                                        <option value=""><?php _e( 'Choose Template', 'woo-import-export' ); ?></option>
                                                                                                </select>
                                                                                        </div>
                                                                                        <div class="wpie_image_option_wrapper wpie_update_template_btn_wrapper">
                                                                                                <div class="wpie_btn wpie_btn_primary wpie_update_template_btn" >
                                                                                                        <i class="fas fa-check wpie_general_btn_icon " aria-hidden="true"></i><?php esc_html_e( 'Update Template', 'woo-import-export' ); ?>
                                                                                                </div>
                                                                                        </div>
                                                                                        <div class="wpie_field_mapping_inner_title"><?php esc_html_e( 'Save Template', 'woo-import-export' ); ?></div>
                                                                                        <div class="wpie_save_template_container">
                                                                                                ...
                                                                                                <div class="wpie_save_template_wrapper">
                                                                                                        <div class="wpie_btn wpie_btn_primary wpie_save_template_btn" >
                                                                                                                <i class="fas fa-check wpie_general_btn_icon " aria-hidden="true"></i><?php esc_html_e( 'Save Template', 'woo-import-export' ); ?>
                                                                                                        </div>
                                                                                                </div>
                                                                                        </div>
                                                                                </div>
                                ...
                                <div class="wpie_section_container wpie_import_step6 wpie_import_step">
                                        ...
                                        <div class="wpie_section_wrapper ">
                                                ...
                                                <div class="wpie_section_content wpie_show">
                                                        ...
                                                        <div class="wpie_import_summary_text wpie_import_new_item_summary_text"><i aria-hidden="true" class="fas fa-chevron-right wpie_general_btn_icon "></i><?php esc_html_e( 'Existing data will be skipped with the data specified in this import.', 'woo-import-export' ); ?></div>
                                                        <div class="wpie_import_summary_text wpie_import_update_item_summary_text"><i aria-hidden="true" class="fas fa-chevron-right wpie_general_btn_icon "></i><?php esc_html_e( 'Existing data will be updated with the data specified in this import.', 'woo-import-export' ); ?></div>                            
                                                        <div class="wpie_import_summary_text wpie_import_update_item_summary_text wpie_import_update_item_created_summary_text"><i aria-hidden="true" class="fas fa-chevron-right wpie_general_btn_icon "></i><?php esc_html_e( "New Items will be created from records that don't match the above criteria.", 'woo-import-export' ); ?></div>
                                                        <div class="wpie_import_summary_text wpie_import_update_item_summary_text wpie_import_update_item_skip_summary_text"><i aria-hidden="true" class="fas fa-chevron-right wpie_general_btn_icon "></i><?php esc_html_e( "New Items will be skipped from records that don't match the above criteria.", 'woo-import-export' ); ?></div>
                                                        <div class="wpie_import_summary_text wpie_import_hidh_speed_text"><i aria-hidden="true" class="fas fa-chevron-right wpie_general_btn_icon "></i><?php esc_html_e( "High-Speed, Small File Processing enabled. Your import will fail if it takes longer than your server's max_execution_time.", 'woo-import-export' ); ?></div>
                                                        ...
                                                        <div class="wpie_import_summary_text wpie_import_iteration_text wpie_import_iteration_chunks_text"><i aria-hidden="true" class="fas fa-chevron-right wpie_general_btn_icon "></i><?php esc_html_e( "Your file will be split into 1000 records chunks before processing.", 'woo-import-export' ); ?></div>
                                                </div>
                                        </div>
                                        <div class="wpie_import_action_btn_wrapper ">
                                                <div class="wpie_import_action_container wpie_pre_import_btn">
