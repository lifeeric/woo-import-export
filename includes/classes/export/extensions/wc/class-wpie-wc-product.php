...
class WPIE_WC_Product extends \wpie\export\base\WPIE_Export_Base {
        ...
        public function pre_process_fields( &$export_fields = array (), $export_type = array () ) {
                ...
                $export_fields[ 'product_arrtibute' ] = array (
                        'title'      => __( "Product Attribute", 'woo-import-export' ),
                        'isFiltered' => true,
                ...
                $export_fields[ 'product_fields' ] = array (
                        'title'      => __( "Product Data", 'woo-import-export' ),
                        'isFiltered' => true,
                ...
                if ( $field_type ) {
                        ...
                        switch ( $field_type ) {
                                ...
                                case 'wpie_cf':
                                        ...
                                        switch ( $metaKey ) {
                                                ...
                                                case '_sale_price_dates_to':
                                                        ...
                                                        $_dates = $this->get_date_field( $date_type, $export_data[ $field_name ], $date_format, $site_date_format );
                                ...
                                case "wc-product-attr":
                                        ...
                                        $export_data[ $field_name . "_value" ] = apply_filters( 'wpie_export_product_attribute_value', $this->apply_user_function(  ! empty( $value ) ? implode( '|', $value ) : "", $is_php, $php_func ), $item );
        ...
        public function set_variable_condition( $post_where = array (), $post_join = array () ) {
                ...
                $post_where[] = " $cause $wpdb->posts.post_type = 'product' AND $wpdb->posts.ID NOT IN(SELECT o.ID FROM $wpdb->posts o
                ...
                unset( $cause, $product_where, $product_join );
