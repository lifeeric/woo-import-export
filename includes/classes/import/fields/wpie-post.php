                        ...
                        <div class="wpie_field_mapping_other_option_wrapper">
                                ...
                                <div class="wpie_radio_container">
                                        ...
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_content" class="wpie_checkbox_label"><?php esc_html_e( 'Content', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                                ...
                                                <label for="is_update_item_excerpt" class="wpie_checkbox_label"><?php esc_html_e( 'Excerpt', 'woo-import-export' ); ?></label>
                                        </div>
                                        <div class="wpie_field_mapping_other_option_wrapper">
                                        ...
                                        <?php if ( $wpie_import_type == "product" ) { ?>
                                                ...
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_catalog_visibility" class="wpie_checkbox_label"><?php esc_html_e( 'Catalog Visibility', 'woo-import-export' ); ?></label>
                                                </div>
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_featured_status" class="wpie_checkbox_label"><?php esc_html_e( 'Featured Status', 'woo-import-export' ); ?></label>
                                                </div>
                                                ...
                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                        ...
                                                        <label for="is_update_item_attributes" class="wpie_checkbox_label"><?php esc_html_e( 'Attributes', 'woo-import-export' ); ?></label>
                                                        <div class="wpie_checkbox_container">
                                                                <div class="wpie_field_mapping_other_option_wrapper">
                                                                        ...
                                                                        <label for="wpie_item_update_attributes_all" class="wpie_radio_label"><?php esc_html_e( 'Update all Attributes', 'woo-import-export' ); ?></label>
                                                                </div>
                                                                <div class="wpie_field_mapping_other_option_wrapper">
