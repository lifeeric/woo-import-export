...
class WPIE_Product_Attribute_Import extends \wpie\import\engine\WPIE_Import_Engine {
        ...
        public function process_import_data() {
                ...
                if ( empty( $this->taxonomy ) ) {
                        ...
                        $this->set_log( '<strong>' . __( 'ERROR', 'woo-import-export' ) . '</strong> : ' . __( 'something wrong, Taxonomy not found', 'woo-import-export' ) );
                ...
                if ( $this->is_update_field( "term_description" ) ) {
                        ...
                        $this->wpie_final_data[ 'description' ] = wp_kses_post( html_entity_decode( wpie_sanitize_field( $this->get_field_value( 'wpie_item_term_description' ) ) ) );
                }
                ...
                if ( is_wp_error( $term ) ) {
                        ...
                        $this->set_log( '<strong>' . __( 'ERROR', 'woo-import-export' ) . '</strong> : ' . $term->get_error_message() );
