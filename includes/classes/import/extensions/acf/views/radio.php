<div class="wpie_acf_item_wrapper" >
    ...
    <div class="wpie_field_mapping_radio_input_wrapper">
        ...
        <div class="wpie_radio_container wpie_as_specified_wrapper">
            ...
            <i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e("Specify the value. For multiple values, separate with commas. If the choices are of the format option : Option, option-2 : Option 2, use option and option-2 for values.", "woo-import-export"); ?>"></i>
        </div>
    </div>
</div>