<div class="wpie_acf_item_wrapper wpie_acf_item_post_object_wrapper" >
    ...
    <i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e("Enter the ID or Title. Separate multiple entries with commas.", "woo-import-export"); ?>"></i>
</div>