<div class="wpie_acf_item_wrapper wpie_acf_item_post_object_wrapper" >
    ...
    <i class="far fa-question-circle wpie_data_tipso" data-tipso="<?php esc_attr_e("Specify the user ID, username, or user e-mail address. Separate multiple values with commas.", "woo-import-export"); ?>"></i>
</div>