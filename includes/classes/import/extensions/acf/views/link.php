<div class="wpie_acf_item_wrapper" >
    ...
    <div class="wpie_item_act_label wpie_item_act_label_inner" ><?php esc_html_e('Title', 'woo-import-export'); ?></div>
    ...
    <div class="wpie_item_act_label wpie_item_act_label_inner" ><?php esc_html_e('URL', 'woo-import-export'); ?></div>
    ...
    <div class="wpie_item_act_label wpie_item_act_label_inner" ><?php esc_html_e('Target', 'woo-import-export'); ?></div>
