...
class WPIE_Order_Product_Item extends \wpie\import\base\WPIE_Import_Base {
        ...
        private function prepare_line_item() {
                ...
                $product_name = wpie_sanitize_field( $this->get_field_value( 'wpie_item_order_item_product_name' ) );
                ...
                if ( ! empty( $product_name ) ) {
                        ...
                        $meta_name = wpie_sanitize_field( $this->get_field_value( 'wpie_item_order_item_product_meta_name' ) );

                        $meta_value = wpie_sanitize_field( $this->get_field_value( 'wpie_item_order_item_product_meta_value' ) );
                        ...
                        foreach ( $product_name as $key => $name ) {
                                ...
                                $subtotal = wc_format_decimal( $price ) * absint( $quantity );
