        ...
        public function save_schedule() {
                ...
                if ( ! empty( $interval ) ) {
                        ...
                        if ( ! isset( $schedules[ $interval ] ) ) {
                                ...
                                return new \WP_Error( 'wpie_import_error', __( 'Cron interval is missing', 'woo-import-export' ) );
                        }
                        ...
                        if ( ! $event ) {
                                ...
                                return new \WP_Error( 'wpie_import_error', __( 'Cron event not set', 'woo-import-export' ) );
                        }
                ...
                return new \WP_Error( 'wpie_import_error', __( 'Invalid Cron data', 'woo-import-export' ) );
        }
